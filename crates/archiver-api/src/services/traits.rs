...
// --- PvRepository (sync — PvRegistry is SQLite Mutex-based, μs latency) ---

pub trait PvRepository: Send + Sync {
...
// --- ArchiverControl (async — archive_pv and resume_pv are async) ---
...
#[async_trait]
pub trait ArchiverControl: Send + Sync {
...
// --- ClusterRouter (async — HTTP-based) ---
